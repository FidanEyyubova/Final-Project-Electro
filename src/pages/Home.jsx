  ...
  return (
    <div className="home">
      <div className="container-fluid p-0">
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <div class="carousel-caption d-lg-flex flex-column align-items-end justify-content-center h-100 text-start d-md-flex d-flex">
                  <div>
                    ...
                    <h1 className="pb-5 pt-1">Headphone on <br /> world off</h1>
                    <Link className="shop p-3">SHOP NOW  <FaArrowRightLong className="mb-1"/>
                    </Link>
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                ...
                <div>
                    ...
                    <h1 className="pb-5 pt-1">Luxury AD65 <br /> smart watch</h1>
                    <Link className="shop p-3">SHOP NOW  <FaArrowRightLong className="mb-1"/>
                    </Link>
                  </div>
                </div>
        ...
        <div className="row second g-0 mb-5">
          ...
          <div className="row d-flex justify-content-center align-items-center py-4 three">
            <div className="col-lg-3 col-md-6 col-12">
              <div className="text-center d-flex justify-content-center align-items-center">
                <div className="category d-flex flex-column justify-content-center align-items-center mb-4 pt-4">
                  <img src="https://kontakt.az/media/catalog/product/cache/d2b8752f559224c02f64bf8d7f0b2ee3/t/m/tm-dg-smw-1106-sw-0513_1.png" alt="" className="py-3"/>
            ...
            <div className="col-lg-3 col-md-6 col-12">
              <div className="text-center d-flex justify-content-center align-items-center">
                <div className="category d-flex flex-column justify-content-center align-items-center mb-4 pt-4">
               <img src="https://kontakt.az/media/catalog/product/cache/d2b8752f559224c02f64bf8d7f0b2ee3/t/m/tm-dg-acs-1109-hg-0214_1.png" alt="" className="py-3"/>
               <div className="d-flex gap-5 capt px-2 justify-content-center">
            ...
            <div className="col-lg-3 col-md-6 col-12">
              <div className="text-center d-flex justify-content-center align-items-center">
                <div className="category d-flex flex-column justify-content-center align-items-center mb-4 pt-4">
            <img src="https://kontakt.az/media/catalog/product/cache/ec3348cd707f11bd7a951e83328510dc/t/m/tm-dg-phv-1106-ph-0152_1-5d0d78b4.webp" alt="" className="py-3" />
            ...
            <div className="col-lg-3 col-md-6 col-12">
              <div className="text-center d-flex justify-content-center align-items-center">
                <div className="category d-flex flex-column justify-content-center align-items-center mb-4 pt-4">
               <img src="https://kontakt.az/media/catalog/product/cache/d2b8752f559224c02f64bf8d7f0b2ee3/n/e/new_project_-_2023-05-18t095725.588_1.png" alt="" className="py-3" />
